<template>
  <view class="container">
    ...
    <view
      class="f-header m-t"
      v-if="data.home_groupon_products && data.home_groupon_products.length"
      @click="goGroupCategory"
    >
    ...
    <view class="guess-section">
      <view
        v-for="(item, index) in data.home_groupon_products"
        :key="index"
        class="guess-item"
    ...
    <view
      class="f-header m-t"
      v-if="data.home_recommend_products && data.home_recommend_products.length"
      @click="goCategory"
    >
    ...
    <view
      class="hot-floor"
      v-for="(row, index) in data.home_recommend_products"
      :key="index"
    >
      <view class="cat_name">
        {{ row.title }}
...
export default {
  ...
  methods: {
    ...
    getNavData() {
      this.$http
        ...
        .then((res) => {
          ...
          this.titleNViewBackground = this.carouselList[0]
            ? this.carouselList[0].params
              ? this.carouselList[0].params["color"] || ""
              : ""
            : "";
        });
    },
    ...
    swiperChange(e) {
      ...
      this.titleNViewBackground = this.carouselList[index].params
        ? this.carouselList[index].params.color || ""
        : "";
    },
