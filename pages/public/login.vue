		...
		<view class="wrapper">
			...
			<view class="input-content">
				<view class="login-way">
					<view class="right nav" :class="{active: !loginWay}" @click="setLoginWay(0)">账号密码登录</view>
					<view class="left nav" :class="{active: loginWay}" @click="setLoginWay(1)">短信验证码登录</view>
				</view>
				<!--账号密码登录-->
			...
			<button class="confirm-btn" style="width: 80%;" @click="toLogin" :disabled="logining">登录</button>
			<view class="third-party" style="display: none;">
				<!-- #ifdef H5 -->
			...
			async vendorLogin(code, data) {
				...
				switch (code) {
					case 'WxH5' : {
						...
						window.location.href = "https://www.zjhpw.com" + url
						break;
					}
					case 'WechatMp' : {
